...
public class Door extends Component {
    ...
    private static PositionedShape createShape(final Room room, final Room.WALL wall, final int offset, final int doorWidth) {
    ...
    public Door(final Room room, final Room.WALL wall, final int offset, final int doorWidth, final boolean open, final String name) {
